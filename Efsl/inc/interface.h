...
#elif defined(HW_ENDPOINT_NIOS_2_SD)
    #include "interfaces/nios_2.h"
#elif defined(HW_ENDPOINT_NIOS_2_RAM)
    #include "interfaces/nios2_ram.h"
#elif defined(HW_ENDPOINT_NIOS_2_RAMDISK)
    #include "interfaces/nios2_ramdisk.h"
#else
